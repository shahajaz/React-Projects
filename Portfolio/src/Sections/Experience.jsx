    ...
    >
      ...
      <div className="relative w-[50%] p-[1px] rounded-xl bg-gradient-to-b from-[#ff00af] to-[#ffcc00]">
        ...
        <div className="bg-[#0d0d0d] rounded-2xl p-8 h-full">
          ...
          {/* Role */}
          <h3 className="text-xl font-semibold text-[#ffcc00] leading-tight">
            {exp.role}
          </h3>
          ...
          <div className="flex items-center gap-3 mt-3">
            <img
              src={exp.logo}
              alt={exp.company}
              className="w-10 h-10 object-contain rounded-md bg-white/10 p-1 border border-white/10"
            />
          ...
          <div className="flex flex-wrap gap-2 mt-5">
            {exp.tech.map((t, i) => (
              <span
                key={i}
                className="px-3 py-1 text-xs bg-[#ff00af]/10 text-[#ffcc00] rounded-full border border-[#ff00af]/30"
              >
                {t}
              </span>
            ))}
