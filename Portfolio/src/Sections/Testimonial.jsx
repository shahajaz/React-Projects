...
export default function Projects(){
  ...
  return(
    <section id="testimonials" className="min-h-[120vh] flex flex-col items-center pt-20 md:pt-24 relative text-white px-6 overflow-hidden scroll-mt-24">
      ...
      <motion.div
        ...
        <h2 className="text-3xl md:text-4xl font-semibold px-6 py-3 rounded-full 
          bg-black/80 backdrop-blur-md relative inline-block mx-auto">
            ...
            <span className="bg-gradient-to-r from-[#ff00af] to-[#ffcc00] bg-clip-text text-transparent">Testimonials</span>
          </h2>
