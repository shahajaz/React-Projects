...
//     <section
//       id="contact"
//       className="min-h-[120vh] flex flex-col items-center pt-20 md:pt-24 pb-20 md:pb-24 relative text-white bg-[#021c1e] px-6 overflow-hidden scroll-mt-24"
//     >
//       <motion.div
...
//       >
//         {/* Inner Container */}
//         <div className="bg-black rounded-xl p-8 grid md:grid-cols-2 gap-8 justify-items-center">
...
//                       whileHover={{ y: -6 }}
//                       whileTap={{ scale: 0.9 }}
//                       className="p-3 border-2 border-white/20 rounded-full flex items-center justify-center"
//                       onMouseEnter={(e) => {
...
//             whileInView="show"
//             viewport={{ once: true }}
//             className="w-full max-w-md bg-gradient-to-r from-[#ff00af] to-[#ffcc00] p-[2px] rounded-xl"
//           >
...
//                   placeholder="Name"
//                   required
//                   className="w-full bg-transparent border border-pink-500 rounded-full px-4 py-2 text-white"
//                 />
...
//                   placeholder="Message"
//                   rows="6"
//                   className="w-full bg-transparent border border-pink-500 rounded-xl px-4 py-2 text-white"
//                 />

//                 <motion.button
//                   variants={fadeUp}
//                   type="submit"
//                   className="w-full bg-gradient-to-r from-[#ff00af] to-[#ffcc00] text-white py-2 rounded-full font-semibold flex items-center justify-center gap-4"
//                 >
//                   Submit
      ...
      >
        ...
        <div className="bg-black rounded-xl p-8 grid md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            whileInView="show"
            viewport={{ once: true }}
            className="bg-gradient-to-r from-[#ff00af] to-[#ffcc00] p-[2px] rounded-xl mx-auto md:mx-0"
          >
            <div className="bg-[#0a0a0a] rounded-[calc(0.75rem-2px)] p-6 h-full">
              <motion.h2
                variants={fadeUp}
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#ff00af] to-[#ffcc00] text-white py-2 rounded-full font-semibold shadow-lg hover:shadow-[0_0_15px_#ff00af] flex items-center justify-center gap-4"
                >
                  Submit
                  <IoIosSend className="text-lg" />
                </motion.button>
